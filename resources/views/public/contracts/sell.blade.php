...
@section('title', "Sell Contract | Move Right®")
                    ...
                    <div>
                        ...
                        <div class=" body">
                            ...
                            <ol start="1">
                                ...
                                <li value="3" id="style-k4MYr" class="style-k4MYr"><span>The term of the tenancy commences on <input type="date" name="from" value="{{ date('Y-m-d') }}" >  and ends on <input type="date" name="to" >
                                    (the "Term").</span><br>
                                </li>
                                        ...
                                        <td id="style-P1ekL" class="style-P1ekL">
                                            <p id="style-cdMrY" class="style-cdMrY">
                                                <div class="file-container">
                                                    ...
                                                    <input type="file" name="landlord_signature" id="landlord_signature" class="file-input" accept=".png, .jpg, .jpeg">
                                        ...
                                        <td id="style-nE4lK" class="style-nE4lK">
                                            <p id="style-iw8Q8" class="style-iw8Q8">
                                                <div class="file-container">
                                                    ...
                                                    <input type="file" name="buyer_signature" id="buyer_signature" class="file-input" accept=".png, .jpg, .jpeg">
