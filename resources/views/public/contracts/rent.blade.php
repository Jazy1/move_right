...
@section('content')
    ...
    <div id="outputPage" class="snipcss-nPzl5">
        <form action="{{ route("public.contract.rent") }}" method="POST">
            @csrf
                    ...
                    <div>
                        ...
                        <div class=" body">
                            ...
                            <ol start="1">
                                ...
                                <li value="3" id="style-k4MYr" class="style-k4MYr"><span>The term of the tenancy commences on <input type="date" name="from" value="{{ date('Y-m-d') }}" readonly>  and ends on <input type="date" name="to" required>
                                    (the "Term").</span><br>
                                </li>
                                ...
                                <li value="30" id="style-7XyOQ" class="style-7XyOQ"><span>For any matter relating to this tenancy, the Tenant may be contacted at the Property or through the phone number below:</span><br>
                                    <ol start="1">
                                        <li value="1" id="style-HdkrD" class="style-HdkrD"><span>Name: Sodaybaz.</span><br>
                                        </li>
                                        <li value="2" id="style-Vg46N" class="style-Vg46N"><span>Phone: &nbsp;66699 9.</span><br>
                                        </li>
                                    </ol>
                                </li>
                                        ...
                                        <td id="style-P1ekL" class="style-P1ekL">
                                            <p id="style-cdMrY" class="style-cdMrY">
                                                <div class="file-container">
                                                    ...
                                                    <input type="file" name="landlord_signature" id="landlord_signature" class="file-input" accept=".png, .jpg, .jpeg" required>
                                        ...
                                        <td id="style-nE4lK" class="style-nE4lK">
                                            <p id="style-iw8Q8" class="style-iw8Q8">
                                                <div class="file-container">
                                                    ...
                                                    <input type="file" name="buyer_signature" id="buyer_signature" class="file-input" accept=".png, .jpg, .jpeg" required>
