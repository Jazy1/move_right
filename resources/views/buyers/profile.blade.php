        ...
        <form action="{{ route("buyers.profile.update", $buyer->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="bg-white card-box border-20">
                ...
                <div class="user-avatar-setting d-flex align-items-center mb-30">
                    <img id="profilePicture" src="{{ asset("/images/lazy.svg") }}" data-src="{{ $buyer->profile_picture ? Storage::url($buyer->profile_picture) : Storage::url("profile-pictures/default.svg") }}
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="dash-input-wrapper mb-30">
                            ...
                            <input type="text" placeholder="John Doe" value="{{ $buyer->name }}" name="name">
                        </div>
                        <!-- /.dash-input-wrapper -->
                    </div>
                    {{-- <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="dash-input-wrapper mb-30">
                            ...
                            <input type="email" placeholder="user@gmail.com" name="email" value="{{ $buyer->email }}" >
                        </div>
                        <!-- /.dash-input-wrapper -->
                    </div>
                    {{-- <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <div class="dash-input-wrapper mb-30">
                            ...
                            <input type="tel" placeholder="+69 666999" name="phone" value="{{ $buyer->phone }}">
                        </div>
                        <!-- /.dash-input-wrapper -->
                    </div>
                    {{-- <div class="col-sm-6">
                    ...
                    <div class="col-12">
                        <div class="dash-input-wrapper">
                            ...
                            <textarea class="size-lg"
                                placeholder="Tell about yourself.." name="about">{{ $buyer->about }}</textarea>
                        ...
                        <div class="dash-input-wrapper mb-25">
                            ...
                            <select class="nice-select" name="city_id" id="city">
                                ...
                                @foreach($cities as $city)
                                    <option value="{{ $city->id }}" {{ $buyer->location->city->id  == $city->id ? 'selected' : '' }} >{{ $city->name }}</option>
                                @endforeach
                            </select>
